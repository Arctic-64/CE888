...
def mode_train():
    train_ds = tf.keras.preprocessing.image_dataset_from_directory(
        training_data, validation_split=0.2, subset="training", seed=9550, image_size=image_size,
        batch_size=batch_size, shuffle=True
    )

    val_ds = tf.keras.preprocessing.image_dataset_from_directory(
        training_data, validation_split=0.2, subset="validation", seed=9550, image_size=image_size,
        batch_size=batch_size, shuffle=True
    )
